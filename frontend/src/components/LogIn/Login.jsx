...
class Login extends React.Component {
  processFormInput = (e) => {
    ...
    console.log(data);
    axios.post('http://localhost:5555/api/auth', data).then((response) => {
              ...
              <div className="p-2 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={this.processFormInput}>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    ...
                    {' '}
                    <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Signup here</a>
                  </p>
                </form>
              </div>
            </div>
